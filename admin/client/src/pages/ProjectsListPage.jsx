  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-display text-post-ink text-3xl">Projects</h1>
        <Link
          to="/projects/new"
      ...
      {projects.length === 0 ? (
        <p className="text-post-muted text-sm">No projects yet.</p>
      ) : (
          ...
          {projects.map((project, index) => (
            <div
              ...
              className={`flex items-center justify-between px-5 py-3.5 ${
                index < projects.length - 1 ? "border-b border-post-rule" : ""
              }`}
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-[10px] text-post-muted uppercase tracking-wider">{project.type}</span>
                  {project.isNew && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded bg-gold-faint text-gold-dim">NEW</span>
                  )}
